# Apprentice Serpentine Coding Challenge
...
Your job is to fill in the function so that it trains the taxi by updating the Q-table using the aforementioned equation.
