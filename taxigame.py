"""easy_taxigame.py
        A basic introduction into the concepts of machine learning. This script acts as a solution file and
    ...
    for i in range(episodes):
        ...
        while not done:
            ...
            if random.uniform(0, 1) < epsilon:
                ...
                action = np.argmax(q_table[state])  # Exploit learned action (q_table)
